      ...
      <main className="main ">
        ...
        <div className="max-w-[1400px] mx-auto !px-3 sm:!px-6 md:!px-10 lg:!px-[60px] !py-5 ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-18">
            ...
            {/* full content  */}
            <div className="col-span-1 lg:col-span-12 order-1 lg:order-1">
              {/* Product Image and Info */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mb-10">
                <div>
                  <div className="relative w-full !h-[380px] sm:!h-[350px] md:!h-[600px] lg:!h-[750px]"
                      ...
                      >
                        {images.map((img, index) => (
                          <SwiperSlide key={index}>
                            ...
                            >
                              <div className="w-full !h-16 sm:h-24 md:!h-32 relative">
                                <Image
                                  src={img.thumb}
                                  alt="thumb"
                                  fill
          ...
          ${selectedSize === size
              ...
              {/* Tab Content */}
              <div className="!mb-10  sm:!mx-4 md:!mx-6 lg:!mx-15">
                ...
                <div className='!mt-18'>
                  <h2 className="text-2xl font-bold !mb-3" >Reviews (3)</h2>
                  <div className="w-full h-[1px]  relative !mb-6 bg-[var(--border-color)]" >
                    <div className="absolute left-0 top-0 h-[2px] w-16 sm:w-20 bg-[var(--primary)]"></div>
              ...
              <div className="!mt-12 !mb-18">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 !px-4 sm:!px-0">
                  ...
                  >
                    <div className="relative w-full !h-78 sm:h-48 !mb-4 overflow-hidden rounded-lg group">
