...
import { BadgeCheck, ChevronRight, ChevronLeft, ArrowRight, RefreshCcw, Wallet, Heart, Repeat, Search, Filter, Facebook, Twitter, Instagram, MessageCircle } from "lucide-react";
...
export default function ProductViewPage() {
      ...
      <main className="main ">
        ...
        <div className="max-w-[1400px] mx-auto !px-3 sm:!px-6 md:!px-10 lg:!px-[60px] !py-5 ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-18">
            ...
            <div className="col-span-1 lg:col-span-9 order-1 lg:order-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mb-10">
                <div>
                  <div className="relative w-full !h-[380px] sm:!h-[350px] md:!h-[400px] lg:!h-[550px]"
                  ...
                  <div className='relative'>
                      ...
                      >
                        {images.map((img, index) => (
                          <SwiperSlide key={index}>
                            ...
                            >
                              <div className="w-full !h-16 sm:h-24 md:!h-25 relative">
                                <Image
                                  src={img.thumb}
                                  alt="thumb"
                                  fill
                    ...
                    <button className="custom-swiper-prev absolute left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white transition-all duration-300 -translate-x-1/2">
                      <ChevronLeft size={20} />
                    </button>

                    <button className="custom-swiper-next absolute right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white transition-all duration-300 translate-x-1/2">
                ...
                <div className="space-y-6 !mb-8">
                  <h1 className="text-xl sm:text-4xl font-bold !mb-2 text-[var(--text-main)]">
                    Colorful Pattern Shirts HD450
                  </h1>
                  <div className="flex justify-between items-center !mb-8">
                    <p className="!mb-2 !mt-4 text-[var(--primary)]"><span className="font-medium !mr-4 text-[var(--text-main)]" >Brands:</span>Boostrap</p>
                  ...
                  {/* Price */}
                  <div className="flex items-center gap-3 !mb-6 border-y py-4 border-[var(--border-color)]" >
                  ...
                  {/* Description */}
                  <p className="text-sm md:text-base !mb-6 leading-relaxed text-[var(--text-muted)]" >
                  ...
                  {/* Features */}
                  <ul className="space-y-4 text-sm md:text-base !mb-6 text-[var(--text-muted)]" >
                  ...
                  <div className="!mb-6 flex items-center gap-4">
                    <p className="text-sm font-medium w-16 text-[var(--text-main)]" >Color</p>
                  ...
                  {/* Size Selection */}
                  <div className="!mb-6 flex items-center gap-4">
                    <p className="text-sm font-medium w-16 text-[var(--text-main)]">Size</p>
          ...
          ${selectedSize === size
                              ...
                              : 'bg-white text-[var(--text-muted)] border-[var(--border-color)] hover:bg-[var(--primary)] hover:text-white hover:border-[var(--primary)]'
                            }`}
                        >
                          {size}
                        </button>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-5 !mb-9">
                    {/* Quantity */}
                    <div className="flex items-center border rounded overflow-hidden border-[var(--border-color)]" >
                      <button
                        onClick={() => quantity > 1 && setQuantity(quantity - 1)}
                        className="!p-2 border-r hover:bg-gray-50 transition-colors border-[var(--border-color)] text-[var(--text-muted)]"

                      >
                        -
                      </button>
                      <span className="!p-2 text-center min-w-[50px] text-[var(--text-main)]" >
                        {quantity}
                      </span>
                      <button
                        onClick={() => setQuantity(quantity + 1)}
                        className="!p-2 border-l hover:bg-gray-50 transition-colors border-[var(--border-color)] text-[var(--text-muted)]"
                    ...
                    {/* Add to Cart */}
                    <button
                      className="!px-10 !py-2 rounded text-white bg-[var(--primary)] hover:bg-[var(--primary-hover)] transition-colors duration-200"
                    >
                      Add to cart
                    </button>
                  ...
                  <div className="text-sm mb-6 space-y-2 border-t pt-5  !mb-5 border-[var(--border-color)] text-[var(--text-muted)]">
                    <p className="!mb-2 !mt-4 text-[var(--primary)]" ><span className="font-medium text-[var(--text-main)]" >SKU:</span> FWM15VKT</p>
                    <p className="!mb-2 text-[var(--primary)]" ><span className="font-medium text-[var(--text-main)]">Tags:</span> Cloth, Women, Dress</p>
                    <p className="!mb-2 text-[var(--primary)]" ><span className="font-medium text-[var(--text-main)]">Availability:</span> 8 Items In Stock</p>
                  </div>
                </div>
              </div>
              ...
              <div className="!mb-10  sm:!mx-4 md:!mx-6 lg:!mx-1">
                {activeTab === "DESCRIPTION" && (
                  <div>
                    ...
                    </p> <p className="text-sm md:text-base leading-relaxed !mb-4 text-[var(--text-muted)]">
                    ...
                    <div className="!mb-8">
                      <ul className="!space-y-3 text-sm text-[var(--text-muted)]" >
                        ...
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[var(--text-muted)] !mt-2 flex-shrink-0"></span>
                          <span className="font-medium w-32 text-[var(--text-main)]" >Quantity Per Case</span>
                          <span>100ml</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[var(--text-muted)] !mt-2 flex-shrink-0"></span>
                          <span className="font-medium w-32 text-[var(--text-main)]" >Ethyl Alcohol</span>
                          <span>70%</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[var(--text-muted)] !mt-2 flex-shrink-0"></span>
                          <span className="font-medium w-32 text-[var(--text-main)]" >Piece In One</span>
                          <span>Carton</span>
                        </li>
                      </ul>
                    </div>
                    <div className="w-full h-px !mb-4 bg-[var(--border-color)]"></div>

                    {/* Additional Description */}
                    <p className="text-sm md:text-base leading-relaxed !mb-6 text-[var(--text-muted)]" >
                    ...
                    <h3 className="font-bold text-lg !mb-2 text-[var(--text-main)]" >Packaging & Delivery</h3>
                    <div className="w-full h-px !mb-4 bg-[var(--border-color)]"></div>
                    <p className="text-sm md:text-base leading-relaxed !mb-4 text-[var(--text-muted)]">
                    ...
                    <table className="w-full text-sm" style={{ color: 'var(--text-main)', }}>
                      <tbody>
                        <tr className="border-b border-[var(--border-color)]">
                          <td className="!py-3 !px-4 font-medium border-r text-[var(--text-main)] border-[var(--border-color)]" style={{ width: '40%' }}>
                            Stand Up
                          </td>
                          <td className="!py-3 !px-4">35"L x 24"W x 37-45"H (front to back wheel)</td>
                        </tr>
                        <tr className="border-b border-[var(--border-color)]">
                          <td className="!py-3 !px-4 font-medium border-r text-[var(--text-main)] border-[var(--border-color)]">
                            Folded (w/o wheels)
                          </td>
                ...
                {activeTab === "REVIEWS" && (
                  <div>
                        ...
                        <div className="!mb-6 pb-6 border-b flex gap-6 border-[var(--border-color)]" >
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex gap-4 text-xs !mb-3">
                              ...
                              <button
                                className="inline-flex items-center gap-1 text-[var(--primary)] hover:text-[var(--primary)] transition-colors"
                              >
                    ...
                    {/* Review Form */}
                    <div className="border-t !pt-8 border-[var(--border-color)]" >
                      <h3 className="text-xl font-bold !mb-4 text-[var-(--text-main)]" >Add a review</h3>
                      <div className="!mb-6">
                      ...
                      <div className="!space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            rows={4}
                            className="w-full !p-3 border rounded-lg text-sm border-[var(--border-color)] bg-[var(--bg-primary)] text-[var(--text-main)]"
              ...
              <div className="!mt-12 !mb-18">
                ...
                <div className="w-full h-[1px]  relative !mb-6 bg-[var(--border-color)]" >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 !px-4 sm:!px-0">
                  ...
                  >
                    <div className="relative w-full !h-55 sm:h-48 !mb-4 overflow-hidden rounded-lg group">
  ...
  opacity-0 md:opacity-0 md:group-hover:opacity-100 transition duration-300
  hidden md:flex">
  ...
  bg-[var(--primary)] text-white text-xs !px-2 !py-1 rounded opacity-0 
    ...
    group-hover/icon:-translate-y-1 transition-all duration-200">
                    ...
                    <h3 className="font-medium text-sm sm:text-base !mb-2 px-2 text-[var(--text-main)] " >Colorful HomeSpeak  Goole</h3>
                    ...
                    <div className="flex items-center justify-center gap-3 pb-4">
                      <p className="font-bold text-lg text-[var(--primary)]" >$238.85</p>
                      <div className="flex items-center gap-1">
                        <span className="text-xs line-through text-[var(--text-muted)]" >$245.8</span>
                      </div>
                    </div>
                  </div>
  ...
  bg-[var(--primary)] text-white text-xs !px-2 !py-1 rounded opacity-0 
    ...
    group-hover/icon:-translate-y-1 transition-all duration-200">
                    ...
                    <h3 className="font-medium text-sm sm:text-base !mb-2 px-2 text-[var(--text-main)]">
                    ...
                    <div className="flex items-center justify-center gap-3 pb-4">
                      <p className="font-bold text-lg text-[var(--primary)]" >$138.85</p>
                      <div className="flex items-center gap-1">
                        <span className="text-xs line-through text-[var(--text-muted)]" >$145.8</span>
                      </div>
                    </div>
                  </div>
  ...
  bg-[var(--primary)] text-white text-xs !px-2 !py-1 rounded opacity-0 
    ...
    group-hover/icon:-translate-y-1 transition-all duration-200">
                    ...
                    <div className="flex items-center justify-center gap-3 pb-4">
                      <p className="font-bold text-lg text-[var(--primary)]" >$738.85</p>
                      <div className="flex items-center gap-1">
                        <span className="text-xs line-through text-[var(--text-muted)]" >$945.8</span>
                      </div>
                    </div>
                  </div>
  ...
  bg-[var(--primary)] text-white text-xs !px-2 !py-1 rounded opacity-0 
    ...
    group-hover/icon:-translate-y-1 transition-all duration-200">
              ...
              <div
                className="!mb-8  w-full h-[150px] sm:h-[120px] md:h-[200px] border rounded-lg relative overflow-hidden group border-[color:var(--border-color)]"
              ...
              >
                ...
                <div className="relative z-10 !px-6 md:!px-12 flex flex-col justify-center h-full">
                  ...
                  <h3
                    className="text-lg sm:text-xl md:text-2xl mb-2 transition-transform duration-300 group-hover:translate-x-4 text-[color:var(--text-main)]"
                  ...
                  <p
                    className="font-bold text-xl sm:text-2xl md:text-3xl leading-tight text-[color:var(--text-main)]"
            ...
            {/* Left Sidebar */}
            <div className="col-span-1 lg:col-span-3 order-2 lg:order-1 mb-6 lg:mb-0 lg:sticky lg:top-0 h-fit">
              <div className="grid   lg:grid-cols-1 gap-6 lg:gap-15">
                <div className="mb-0 lg:mb-8 border rounded-lg !p-5 border-[color:var(--border-color)]" >
                  <div className="relative">
                    <h2 className="font-bold text-base sm:text-lg !mb-4 sm:mb-5 !pb-3 text-[color:var(--text-main)] border-b border-[color:var(--border-color)] border-solid" >  Category</h2>

                    <div className="absolute bottom-0 left-0 w-1/2 h-[2px] bg-[var(--primary)]" ></div>
                  </div>
                ...
                <div className="mb-0 lg:mb-8 border rounded-lg !p-5 border-[var(--border-color)]" >
                  <div className="!mb-6">
                    <div className="relative">
                      <h2
                        className="font-bold text-base sm:text-lg !mb-4 sm:!mb-5 !pb-3 text-[var(--text-main)] border-b border-solid border-[var(--border-color)]"
                      ...
                      <div className="relative !mb-8 !pt-8 !px-1">
                        ...
                        <div className="w-full h-1 bg-gray-200 rounded-full bg-[var(--border-color)]" ></div>
                        <div
                  ...
                  <div className="mb-6">
                    <h2 className="font-bold text-base sm:text-lg !mb-4 sm:mb-5 !mt-5 text-[var-(--text-main)]">Color</h2>
                    <ul className="!space-y-3 text-sm text-[var-(--text-muted)]" >
                  ...
                  <div className="mb-6">
                    <h2 className="font-bold text-base sm:text-lg !mb-4 sm:mb-5 !mt-5 text-[var-(--text-main)]">Item Condition</h2>
                    <ul className="!space-y-3 text-sm text-[var-(--text-muted)]" >
                      <li className="flex items-center gap-2 cursor-pointer transition-colors">
                        <input type="checkbox" className="w-4 h-4 accent-[var(--primary)]" />
                        <span>New (1506)</span>
                ...
                <div className="mb-0 lg:mb-8 border rounded-lg !p-6 border-[var(--border-color)]" >

                  <div className="mb-6">
                    <div className="relative">
                      <h2 className="font-bold text-base sm:text-lg !mb-4 sm:mb-5 !pb-3 text-[var(--text-main)] border-b border-solid border-[var(--border-color)]"
                    ...
                    <div className="!space-y-6 ">
                      ...
                      {/* Product 1 */}
                      <div className="flex gap-3 items-center group cursor-pointer !pb-4 border-b border-[var(--border-color)]" >
                        ...
                        <div className="flex-1">
                          <h4 className="text-sm font-medium mb-1 line-clamp-2 text-[var-(--primary)]" >
                            Chen Cardigan
                          </h4>
                      ...
                      <div className="flex gap-3 items-center group cursor-pointer !pb-4 border-b" style={{ borderColor: 'var(--border-color)' }}>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-1 mb-1">
                            <div className="flex">
                              {[...Array(4)].map((_, i) => (
                                <Star key={i} className="w-3 h-3 fill-current text-[var(--star-rating)]" />
                              ))}
                              {/* 5th star - plain/gray */}
                              <Star className="w-3 h-3" style={{ color: '#d1d5db' }} />
                            </div>
                ...
                >
                  ...
                  <div className="relative z-10 !p-5 flex flex-col justify-center h-full min-h-[380px]">
                    <h3 className="text-sm mb-3 text-[var(--text-main)]" >Women Zone</h3>
                    ...
                    <a
                      href="#"
                      className="inline-flex items-center gap-2 font-medium hover:gap-3 transition-all duration-300 text-sm text-[var(--primary)]"
