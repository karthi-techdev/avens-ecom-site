          ...
          <div className="w-full max-w-[700px]">
              ...
              {["firstName", "email"].map((field) => (
                <div key={field} className="w-full !mt-4 md:!mt-5 text-left">
                  <input
                    ...
                    className={`w-full !p-3 border border-[var(--border-color)] rounded outline-none text-sm focus:border-[var(--blog-text)] ${error[field] ? "border-red-500" : ""
                      }`}
                  />
                  {error[field] && (
            ...
            <div className="!mt-4 md:!mt-5 mb-6 text-left">
              <textarea
                ...
                onChange={handleChange}
                placeholder="Message"
                className={`w-full h-[150px] !p-4 border border-[var(--border-color)] rounded resize-none outline-none text-sm focus:border-[var(--blog-text)] ${error.message ? "border-red-500" : ""
                  }`}
              />
              {error.message && (
                <p className="text-red-500 text-xs !mt-1">
