...
//     priceRange = [0, 2000],           // ✅ Added default value
//     setPriceRange = () => {},         // ✅ Added default empty function
...
const ShopSidebar: React.FC<ShopSidebarProps> = ({ 
    ...
    // Max value for the range slider
    const max = 2000; 
    ...
    return (
        <div className="!space-y-6 lg:!space-y-8 max-w-[300px] w-full">
            ...
            {/* --- New Products Widget (MADE CLICKABLE) --- */}
            <div className="border rounded-xl !p-6 shadow-sm bg-white" style={{ borderColor: 'var(--border-color)' }}>
                <div className="relative !mb-5">
                    <h5 className="font-bold text-lg !pb-3 border-b text-[#253D4E]">New Products</h5>
                    <span className="absolute bottom-0 left-0 w-20 h-[2px] bg-[#3BB77E]"></span>
                ...
                <div className="!space-y-5">
                    {latestProducts.map((product) => (
                        // ✅ Wrap the item in a Link to enable dynamic navigation
                        <Link 
                            key={product._id} 
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                {/* Added a small rating star UI to match standard ecommerce sidebars */}
