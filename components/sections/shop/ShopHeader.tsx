...
//     const [sortSelected, setSortSelected] = useState('Release Date');
...
interface ShopHeaderProps {
    totalItems: number;
    sortSelected: string;           // Added prop
    setSortSelected: (val: string) => void; // Added prop
}

const ShopHeader = ({ totalItems, sortSelected, setSortSelected }: ShopHeaderProps) => {
    const router = useRouter();
    const pathname = usePathname();
