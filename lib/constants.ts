export const products = [
  {
    ...
    // slug: "colorful-pattern-shirt", // ✅ added
    category: "Clothing",
    price: 1299,
    oldPrice: 1999,
    rating: 4.5,
...
export const shopProducts: ShopProduct[] = [
  {
    ...
    description:
      "Experience the ultimate comfort and style with our Colorful Pattern Shirts. Made from premium cotton, these shirts feature vibrant patterns that make a bold statement.",
  },
  {
    id: 102,
    badge: "New",
    ...
    description:
      "Reach for the stars with our Cartoon Astronaut T-Shirts. Perfect for space enthusiasts and those who love a quirky, modern look.",
  },
  {
    id: 103,
    badge: "Best Sell",
    ...
    description:
      "The Plain Striola Shirts offer a classic, timeless design. Ideal for both formal and semi-formal occasions, these shirts are a must-have in every wardrobe.",
  },
  {
    id: 104,
    badge: "Sale",
    ...
    img2: "/shop/product-hover-1.jpg",
    description:
      "Wear a piece of art with our Landscape Painting Shirt. Featuring beautiful, scenic prints, this shirt is designed to turn heads.",
  },
  {
    id: 105,
    badge: "-30%",
    ...
    img2: "/shop/product-hover-1.jpg",
    description:
      "Our Letter Print T-Shirt is a versatile addition to your casual collection. Simple yet stylish, it's perfect for everyday wear.",
  },
  {
    id: 106,
    badge: "-22%",
    ...
    img2: "/shop/product-hover-1.jpg",
    description:
      "Bring a touch of modern design to your outfit with our Element Pattern Print Shirts. Features a unique geometric print for a contemporary look.",
  },
  {
    id: 107,
    badge: "New",
    ...
    description:
      "The Vintage Henley Shirts offer a relaxed, classic fit. Made with breathable fabric, they're the ideal choice for a comfortable day out.",
  },
  {
    id: 108,
    badge: "Best Sell",
    ...
    description:
      "Stay fresh and focused with our Cotton Leaf Printed accessories. Inspired by nature, these items add a natural touch to any ensemble.",
  },
  {
    id: 109,
    badge: "Best Sell",
    ...
    description:
      "Another variation of our popular Plain Striola Shirts. Consistent quality and style in every stitch.",
  },
];
